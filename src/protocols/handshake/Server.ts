 ...
 */
export class HandshakeServerError extends Schema.TaggedErrorClass<HandshakeServerError>()("HandshakeServerError", {
  cause: Schema.Defect,
}) {}
...
const handleProposal = (
  ...
  channel: { send: (data: Uint8Array) => Effect.Effect<void, MultiplexerEncodingError | Socket.SocketError, Scope.Scope> },
) =>
...
export class HandshakeServer extends ServiceMap.Service<HandshakeServer, {
  start: () => Effect.Effect<
    void,
    HandshakeServerError | MultiplexerHeaderError | MultiplexerEncodingError | Socket.SocketError | Schema.SchemaError,
    Scope.Scope
  >;
