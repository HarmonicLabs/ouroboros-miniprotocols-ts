...
export const NodeToNodeVersionTable = Schema.Record(
  VersionNumber,
  NodeToNodeVersionData,
);
export const NodeToClientVersionTable = Schema.Record(
  VersionNumber,
  NodeToClientVersionData,
);

// Refuse reasons (following current implementation and CDDL spec)
export const RefuseReasonVersionMismatch = Schema.TaggedStruct(
  "VersionMismatch",
  {
...
export const RefuseReasonHandshakeDecodeError = Schema.TaggedStruct(
...
export const HandshakeProposeVersions = Schema.TaggedStruct(
  "MsgProposeVersions",
  {
    versionTable: Schema.Union([
      NodeToNodeVersionTable,
