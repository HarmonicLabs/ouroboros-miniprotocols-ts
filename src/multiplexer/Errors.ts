...
export class MultiplexerBufferError extends Schema.ErrorClass<MultiplexerBufferError>("MultiplexerBufferError")({
  cause: Schema.Defect,
}) {}


export type MultiplexerError = MultiplexerConnectionError | MultiplexerProtocolError | MultiplexerFrameError | MultiplexerBufferError | MultiplexerAuxError
